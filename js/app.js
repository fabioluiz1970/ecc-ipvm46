...
// Cadastro agora é um objeto com 4 listas independentes
...
/* =======================================================
   3. CADASTRO DE PARÂMETROS INDEPENDENTES (INCLUIR/EXCLUIR)
======================================================== */
...
/* =======================================================
   4. CRONOGRAMA GERAL (PREVISTO + TEMPO DA ATIVIDADE)
======================================================== */
...
document.getElementById("cronogramaForm").addEventListener("submit", function(e) {
    ...
    const item = {
        id: Date.now(),
        numero: cronograma.length + 1, // Número da atividade
        ...
        fimPrev: fimPrev,
        tempoPrev: calcularDuracao(inicioPrev, fimPrev), // Tempo da atividade (Fim - Início)
        inicioReal: "",
        fimReal: "",
...
function deleteCronograma(id) {
    if(confirm("Deseja excluir esta atividade do cronograma?")) {
        ...
        // Renumera as atividades após exclusão
...
/* =======================================================
   5. LÓGICA DE STATUS E CARDS (SÁBADO / DOMINGO)
======================================================== */
        ...
        container.innerHTML += `
            <div class="card">
                ...
                <div class="card-info">
                    ...
                    <p><strong>Previsto:</strong> {item.fimPrev} <span class="tempo-destaque">Duração: ${item.tempoPrev}</span></p>
...
======================================================== */
function renderAll() {
    // 1. Renderiza Listas de Parâmetros (Cadastro Independente)
    ...
    // 3. Renderiza a Lista do Cronograma Geral
        ...
        cronoDiv.innerHTML += `
            <div class="lista-item">
                <div>
                    ...
                    <br> <small>{item.inicioPrev} às {item.tempoPrev}</span></small>
                    <br> <small>Local: {item.equipe} | Ação: ${item.acao}</small>
                </div>
